...
{
    public partial class FrmProcessoAERMOD : Form
    {
        ...
        public FrmProcessoAERMOD(string diretorio)
        {
            InitializeComponent();
        ...
        #region Eventos FrmProcessoAERMOD
            ...
            try
            {
                p = new Process()
                {
                    StartInfo = new ProcessStartInfo()
                    {
                        ...
                        FileName = Path.Combine(diretorio, "aermod.exe"),
                        Arguments = "",
        ...
        private void FrmProcessoAERMOD_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (p.HasExited == false)
        ...
        private void FrmProcessoAERMOD_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Escape:
