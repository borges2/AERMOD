...
{
    public class ClsAERMAP_CartesianoDiscreto
    {
        #region Declarações
        ...
        public ClsAERMAP_CartesianoDiscreto(ConfiguracaoRede configuracaoRede, int codigoDominio)
        {
        ...
        public int Incrementa()
        {
            string sql = "SELECT " +
                         ...
                         "FROM AERMAP_CARTESIANO_DISCRETO A " +

                         "LEFT JOIN AERMAP_CARTESIANO_DISCRETO B ON " +
